...
class U2211_STARTCPPGAME_API CHelpers
{
public:
	template <typename T>
	 ...
	 * GhostTrail 생성
	 */
	static ACGhostTrail* Play_GhostTrail(const TSubclassOf<ACGhostTrail>& InClass, class ACharacter* InOwner)
	{
		 ...
		 * Owner: 소유자
		 * SpawnCollisionHandlingOverride: 충돌처리 방식
		 */		 
